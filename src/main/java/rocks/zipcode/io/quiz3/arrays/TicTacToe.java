...
public class TicTacToe {
    ...
    public String getWinner() {
        ...
        // left-sizzle to right-sizzle--> needs a helper for diagonal wins.
        String[] diagonal = getDiagonal();
        if (allValuesTheSame(diagonal)) {
            return diagonal[0];
        }
        //right sizzle to left sizzle
    ...
    private String[] getOtherDiagonal() {
        String[] diagonal = new String[board.length];
        for (int i = 0; i < board.length; i++) {
